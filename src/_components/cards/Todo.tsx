  ...
  return (
    <comp.Card size={size}>
      <div class="flex h-full w-full flex-col overflow-hidden">
        {/* Header */}
        <div class="flex flex-row items-center justify-between bg-stone-200 p-3">
          <h3 class="font-semibold text-stone-900 leading-tight">To-do</h3>

          <div class="flex flex-row items-center gap-1">
            <span class="font-semibold text-stone-950/50 text-xs">
              {isCompleted ? "Done" : `${percentage}%`}
            </span>

            {isCompleted
              ? (
                <div class="flex size-5 items-center justify-center rounded-full bg-stone-600 text-stone-100">
                  <img
                    src="/icons/check.svg"
                    alt=""
                    class="h-3 w-3"
