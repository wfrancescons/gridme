...
export default async function Link(
  ...
  return (
    <comp.Card size={size} url={url}>
      <div class="h-full w-full overflow-hidden p-4 bg-neutral-100 flex flex-row gap-3 justify-between
      group-[.card-large]/card:flex-col-reverse">
        <div class="flex flex-col flex-1 justify-center gap-3">
          ...
          ">
              <span class="font-bold text-neutral-800 text-base line-clamp-3">
        ...
        {/* Image */}
        {linkData.image && (
          <div class="flex-none flex overflow-hidden aspect-square rounded-2xl
